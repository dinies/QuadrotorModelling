classdef  GraohTest < matlab.unittest.TestCase
  properties
    v1
    v2
    v3
  ...
  methods(TestMethodSetup)
    function MethodSetup(testCase)
      state1.coords= [0;0;0];
      testCase.v1 = Vertex(1,state1);

      state2.coords= [1;0;0];
      testCase.v2 = Vertex(2,state2);

      state3.coords= [1;1;0];
      testCase.v3 = Vertex(3,state3);

      state4.coords= [2;0;0];
      testCase.v4 = Vertex(4,state4);

      state5.coords= [2;1;0];
      testCase.v5 = Vertex(5,state5);
   end
  end
  methods(Test)
    function testAdjacencyMatrixDirected(testCase)
