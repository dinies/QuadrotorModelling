...
obj = CartSym( 1 , 0.0, realDelta_t,x_0,dx_0,ddx_0);

%closed_loop_sym(obj, totSim_t, "position",gains, referenceValues.positions, false);
closed_loop_sym(obj, totSim_t, "velocity",gains, referenceValues.velocities, false);
