function getObstaclesData(hostname,port, cookie)
           % GETOBSTACLESDATA makes an HTTP request through Matlab function send
...
% with the following structure : TODO
%
  import matlab.net.*
  import matlab.net.http.*


  endpoint= "/api/obstacles";
